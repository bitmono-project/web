...
public sealed record CommentRow(Guid Id, string? Author, Guid? AuthorUserId, string Body, bool IsSpoiler, bool IsDeleted, DateTime CreatedAt, DateTime UpdatedAt);
